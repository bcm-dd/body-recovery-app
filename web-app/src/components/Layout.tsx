  ...
  return (
    <div className="flex flex-col min-h-screen bg-void">
      ...
      <div className="flex flex-col flex-1 w-full max-w-[430px] mx-auto bg-base glow-accent">
        ...
        {/* Bottom navigation */}
        <nav className="sticky bottom-0 bg-surface border-t border-border safe-bottom">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    ...
                    'transition-colors duration-fast press-scale',
              ...
              >
                {({ isActive }) => (
                  <>
                    ...
                    <span className="text-caption2">{item.label}</span>
                  </>
                )}
              </NavLink>
            ))}
