/**
 * Chat Screen - Movement & Recovery Companion
 *
 * AI chat interface with streaming responses and workout context.
 * Provides real-time coaching based on current injuries, readiness, and workout state.
 */
