/**
 * Body Map Component - Movement & Recovery Companion
 *
 * Interactive human figure for logging and visualizing pain/injuries.
 * Supports front and back views with tappable body regions.
 */
            ...
            return (
              <G key={region.id}>
                <Path
                  ...
                  fillOpacity={hasHighlight || isSelected ? 0.6 : 0.2}
                  stroke={isActive || isSelected ? colors.accent : colors.border}
