/**
 * Rest Timer Component (Web) - Movement & Recovery Companion
 *
 * Web-specific version of the circular countdown timer.
 * Uses CSS transitions for smooth progress animation.
 */
    ...
    >
      ...
      <View style={styles.actions}>
        <Button
          ...
          variant="ghost"
          size="md"
          style={{ marginRight: spacing[2] } as ViewStyle}
          onPress={onAdd30}
        />
        <Button
          title="Skip Rest"
